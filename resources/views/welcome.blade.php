    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                ...
                <img src="{{ asset('storage/'. setting('site.image_logo')) }}" alt="none" width="300px">
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a 
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Tipo de Cambio Paralelo de Moxos </h2>
                            <span class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed" style="text-align: center; font-size: 15pt"> Oficial Bs.- {{ number_format(setting('site.tipo_cambio_oficial'), 2) }} </span>
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Tipo de cambio para aplicacion de pagos de moxos Import Export
                            </p>
                            <h1 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white"
                                style="text-align: center; font-size: 40pt"> <small> Moxos Bs.-</small>
                                {{ number_format(setting('site.tpo_cambio'), 2) }} </h1>
                        </div>
                    ...
                    <a 
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Calculadora</h2>
                            <br>
                            <!-- Formulario para ingresar el valor -->
                            <form id="tipoCambioForm" >
                                <label class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed" for="valor">Monto Recibido en Bs.- :</label>
                                <input class="form-comtrol" type="text" id="valor" name="valor">
                            </form>

                            <!-- Span para mostrar el resultado -->
                            <p class="mt-6 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">Amortizacion Capital $us.- : <span  style="text-align: center; font-size: 20pt" id="resultado" ></span></p>
                    ...
                    <a 
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Calculo de Cuotas</h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Estamos trabajando para poder briandar un mejor servicio y calculo de creditos en base al tipo de cmabio.
                            </p>
                        </div>
            ...
            <div class="flex justify-center mt-16 px-0 sm:items-center sm:justify-between">
                ...
                <div class="text-center text-sm text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0">
                    Moxos Import Export - Laravel v{{ Illuminate\Foundation\Application::VERSION }} (PHP
                    v{{ PHP_VERSION }}) <a href="#">Iniciar Session</a>
                </div>
            </div>
        </div>
    </div>

     <!-- Incluir jQuery (opcional, para facilitar el manejo de DOM) -->
     <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>

     <!-- Script para realizar el cálculo -->
     <script>
        $(document).ready(function() {
            // Obtener el tipo de cambio desde la configuración PHP
            var tipoCambio = {{ setting('site.tpo_cambio') }};
    
            // Capturar el evento de entrada en el campo de texto
            $('#valor').on('input', function() {
                var valor = parseFloat($(this).val());
                
                // Asegurarse de que valor es un número
                if (!isNaN(valor)) {
                    var resultado = valor / tipoCambio;
