        ...
        <section id="services" class="services section">
            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    @foreach ($marcas as $mark)
                        <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="100">
                            <div class="icon flex-shrink-0"><i class="bi bi-box2-fill"></i></div>
                            <div>
                                <h4 class="title"><a href="#" class="stretched-link">{{ $mark->marca }}</a></h4>
                                <p class="description">{{ $mark->observaciones }}</p>
                            </div>
                        </div>
                    @endforeach
                    <!-- End Service Item -->
                ...
                <section id="testimonials" class="testimonials section dark-background">
                    ...
                    <img src="{{ asset('images/testimonials-bg.jpg') }}" class="testimonials-bg" alt="">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <img src="{{ asset('images/mto/1.png') }}" width="500px" alt="">
                                        <h3>Saul Goodman</h3>
                                        <h4>Ceo &amp; Founder</h4>
                                        <div class="stars">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <img src="{{ asset('images/mto/2.png') }}" width="500px"  
                                            alt="">
                                        <h3>Sara Wilsson</h3>
                                        <h4>Designer</h4>
                                        <div class="stars">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="testimonial-item">
                                        ...
                                        <h3>Jena Karlis</h3>
                                        <img src="{{ asset('images/mto/3.png') }}" width="500px" alt="">
                                        <h4>Store Owner</h4>
                                        <div class="stars">
                                            <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                                                class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <img src="{{ asset('images/mto/4.png') }}" width="500px"  
                                            alt="">
                                        <h3>Matt Brandon</h3>
                                        <h4>Freelancer</h4>
                                        <div class="stars">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                    <img src="{{ asset('images/mto/5.png') }}" width="500px"  
                                            alt="">
                                        <h3>John Larson</h3>
                                        <h4>Entrepreneur</h4>
                                        <div class="stars">
                ...
                <div class="row gy-4">
                    @foreach ($agentes as $agente)
                        <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
                            <div class="member">
                                @if ($agente->image)
                                    {{-- @foreach (json_decode($agente->image) as $img) --}}
                                        @php
                                            $imgs = 'storage/' . str_replace('.', '.', $agente->image);
                                        @endphp
                                        <img src="{{ url($imgs) }}" alt="no image" class="img-fluid">
                                    {{-- @endforeach --}}
                                @else
                                    <p>No images available</p> <!-- Aquí puedes mostrar un mensaje si no hay imagen -->
                                @endif
                                <h4>{{ $agente->name }}</h4>
                                <span>{{ $agente->contact_number }}</span>
                                <div class="social">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="faq-container">
                            ...
                            <div class="faq-item" data-aos="fade-up" data-aos-delay="300">
                                ...
                                <div class="faq-content">
                                    <p>Serna es nuestra marca propia de motocicletas, diseñada para satisfacer las
                                        necesidades
                            ...
                            <div class="faq-item" data-aos="fade-up" data-aos-delay="400">
                                ...
                                <div class="faq-content">
                                    <p>Sí, en Moxos Import Export ofrecemos planes de financiamiento flexibles para que
                                        puedas
                                        adquirir tu moto o electrodoméstico sin afectar tu presupuesto. Puedes pagar en
                                        cuotas
                            ...
                            <div class="faq-item" data-aos="fade-up" data-aos-delay="500">
                                ...
                                <div class="faq-content">
                                    <p>¡Así es! Realizamos envíos a todas las ciudades y departamentos de Bolivia. Los
                                        tiempos
                                        de entrega varían según la ubicación, pero siempre te brindaremos una fecha estimada
                                        al
